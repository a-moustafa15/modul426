...
class UserLoginForm(forms.ModelForm):
    """
    the Class inheritance from django model form and to log a user in the user need the user email and the password to log in  
    """
...
class UserCreationForm(forms.ModelForm):
    ...
    password = forms.CharField(label='Password',required=True,validators=[validate_password] ,widget=forms.PasswordInput())
